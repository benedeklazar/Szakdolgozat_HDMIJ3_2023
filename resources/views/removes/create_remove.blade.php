...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Tiltás') }}</div>
                <div class="card-body">
                    <form class="d-inline" method="POST" action="{{ route('remove_create', ['obj_name' => $obj_name, 'id' => $id]) }}">
                        
                        @csrf
                        <div class="row mb-3">
                            <label for="reason" class="col-md-4 col-form-label text-md-end">{{ __('Indoklás') }}</label>

                            <div class="col-md-6">
                                
                                <textarea rows="5" id="reason" type="text" class="form-control @error('reason') is-invalid @enderror" 
                                name="reason">A tartalom megszegte a közösségi irányelveket!</textarea>                 
                                @error('reason')
    ...
    <div class="row mb-3">
                ...
                <div class="col-md-7">
                    ...
                    <script>
                     ...
                     <br>
                        <button type="submit" class="btn btn-primary">{{ __('Tartalom tiltása') }}</button>
                    </form>
                </div>
            </div>
        </div>
